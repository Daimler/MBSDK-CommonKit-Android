...
import com.daimler.mbcommonkit.preferences.*
import com.daimler.mbcommonkit.security.Crypto

/**
 * Creates a Boolean preference.
 */
fun SharedPreferences.booleanPreference(key: String, default: Boolean = false): Preference<Boolean> =
        DefaultPreference(
 ...
 */
fun Context.getMultiAppSharedPreferences(settingsName: String, sharedUserId: String): SharedPreferences {
